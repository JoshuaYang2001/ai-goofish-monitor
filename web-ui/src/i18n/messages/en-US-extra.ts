const enUSExtra = {
  tasks: {
    ...
    createDialog: { trigger: '+ New Task', title: 'Create Monitoring Task', submit: 'Create Task', submitting: 'Submitting...' },
    ...
    form: {
      ...
      taskTypeStore: 'Store Monitoring Group',
      storeIdLabel: 'Store ID / Profile URL',
      storeIdPlaceholder: 'Paste a store ID or Goofish store profile URL',
      storeIdHint: 'Enter a store ID directly, or paste a store profile URL containing userId.',
      storeNameLabel: 'Store Name (optional)',
      storeNamePlaceholder: 'Example: Store A',
      storeNameHint: 'Leave blank to use the Goofish store name after the first synchronization.',
      storeGroupHintTitle: 'One store becomes one monitoring group',
      storeGroupHintDescription: 'Every run synchronizes all active listings automatically, including newly listed items. Item changes are summarized into one notification per store.',
      ...
      validation: {
        ...
        storeIdRequired: 'Enter a store ID or store profile URL.',
        storeIdInvalid: 'The store ID could not be recognized. Check the profile URL or enter the ID directly.',
      },
    },
    region: {
    ...
    table: {
      headers: { status: 'Status', details: 'Task Details', crawl: 'Crawl Rules', mode: 'Matching', schedule: 'Schedule', actions: 'Actions' },
      ...
      storeGroupType: 'Store Group',
      storeFallbackName: 'Unnamed Store',
      storeId: 'Store ID: {id}',
      fullStoreItems: 'All Active Store Items',
      dynamicSync: 'Dynamically synced every run',
      storeItemTracking: 'Per-item Tracking',
      groupedNotification: 'Grouped by Store',
