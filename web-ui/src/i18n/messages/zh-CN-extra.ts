const zhCNExtra = {
  tasks: {
    ...
    createDialog: { trigger: '+ 创建新任务', title: '创建监控任务', submit: '创建任务', submitting: '提交中...' },
    ...
    form: {
      ...
      taskTypeStore: '店铺监控组',
      storeIdLabel: '店铺 ID / 主页链接',
      storeIdPlaceholder: '粘贴店铺 ID 或闲鱼店铺主页链接',
      storeIdHint: '支持直接输入店铺 ID，也可粘贴包含 userId 的店铺主页链接。',
      storeNameLabel: '店铺名称（可选）',
      storeNamePlaceholder: '例如：A 店铺',
      storeNameHint: '留空时将在首次同步后使用闲鱼店铺名称。',
      storeGroupHintTitle: '以店铺作为一个监控组',
      storeGroupHintDescription: '每次运行会自动同步该店铺的全部在售商品，新上架商品无需手动补充；商品变化会按店铺汇总通知。',
      ...
      cronCustomHintLine1: '支持 5 段：分 时 日 月 周；6 段：秒 分 时 日 月 周；最短执行间隔为 15 分钟。服务端时区为 Asia/Shanghai。',
      ...
      validation: {
        ...
        storeIdRequired: '请输入店铺 ID 或店铺主页链接。',
        storeIdInvalid: '无法识别店铺 ID，请检查店铺主页链接或直接填写 ID。',
      },
    },
    region: {
    ...
    table: {
      headers: { status: '状态', details: '任务详情', crawl: '采集规则', mode: '匹配规则', schedule: '触发规则', actions: '操作' },
      syncing: '数据同步中...',
      empty: '暂无监测任务',
      accountRotate: '轮换',
      accountFixed: '固定',
      ...
      storeGroupType: '店铺监控组',
      storeFallbackName: '未命名店铺',
      storeId: '店铺 ID：{id}',
      fullStoreItems: '全店在售商品',
      dynamicSync: '每次运行动态同步',
      storeItemTracking: '商品逐项跟踪',
      groupedNotification: '按店铺汇总',
      dynamicItems: '动态商品',
      start: '启动',
      stop: '停止',
      stopping: '停止中',
